...
class MyMusic:
    def __init__(self, window ):
        window.geometry('320x190'); window.title('CodeClause Internship'); window.resizable(0,0)
        frame = LabelFrame(window, text='Soham\'s Music Player', bg='#ffff00',font=(20))
        frame.pack(expand=True, fill=BOTH)
        my_str = StringVar()
        l2 = Label(window,textvariable=my_str,fg='red' )
        l2.place(x=10, y=50)
    ...
    def load(self):
        ...
        my_str1 = StringVar()
        l3 = Label(textvariable=my_str1,fg='blue' )
        l3.place(x=90, y=50)
